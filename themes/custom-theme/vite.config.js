    ...
    rollupOptions: {
      ...
      output: {
        entryFileNames: (chunk) => {
          if (chunk.name === "baseindex") {
            return "js/baseindex.js"; // fixed filename
          }
          return "js/[name]-[hash].js"; // keep hash for others
        },
      ...
      input: {
        ...
        baseindex: resolve(__dirname, "assets/js/baseindex.js"),
        basejs: resolve(__dirname, "assets/js/basejs.js"),
        navjs: resolve(__dirname, "assets/js/navjs.js"),
        ...
        nav: resolve(__dirname, "assets/scss/nav.scss"),
        nes: resolve(__dirname, "assets/scss/nes.scss"),
        augui: resolve(__dirname, "assets/scss/augui.scss"),
        title: resolve(__dirname, "assets/scss/title.scss"),
